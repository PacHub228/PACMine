...
public class Font5x7 {
    ...
    static {
        ...
        put(',', 0b00000,0b00000,0b00000,0b00000,0b00100,0b00100,0b01000);
        put('!', 0b00100,0b00100,0b00100,0b00100,0b00100,0b00000,0b00100);
        put('?', 0b01110,0b10001,0b00001,0b00110,0b00100,0b00000,0b00100);
        put('\'', 0b00100,0b00100,0b01000,0b00000,0b00000,0b00000,0b00000);
        ...
        // --- кириллица (заглавные; draw() сам поднимает регистр) ---
        put('А', G.get('A')); put('В', G.get('B')); put('Е', G.get('E')); put('К', G.get('K'));
        put('М', G.get('M')); put('Н', G.get('H')); put('О', G.get('O')); put('Р', G.get('P'));
        put('С', G.get('C')); put('Т', G.get('T')); put('Х', G.get('X'));
        put('Б', 0b11111,0b10000,0b10000,0b11110,0b10001,0b10001,0b11110);
        put('Г', 0b11111,0b10000,0b10000,0b10000,0b10000,0b10000,0b10000);
        put('Д', 0b00111,0b00101,0b00101,0b01001,0b01001,0b11111,0b10001);
        put('Ж', 0b10101,0b10101,0b01110,0b00100,0b01110,0b10101,0b10101);
        put('З', 0b01110,0b10001,0b00001,0b00110,0b00001,0b10001,0b01110);
        put('И', 0b10001,0b10001,0b10011,0b10101,0b11001,0b10001,0b10001);
        put('Й', 0b01010,0b10101,0b10011,0b10101,0b11001,0b10001,0b10001);
        put('Л', 0b00111,0b01001,0b01001,0b01001,0b01001,0b01001,0b10001);
        put('П', 0b11111,0b10001,0b10001,0b10001,0b10001,0b10001,0b10001);
        put('У', 0b10001,0b10001,0b10001,0b01111,0b00001,0b00010,0b01100);
        put('Ф', 0b00100,0b01110,0b10101,0b10101,0b10101,0b01110,0b00100);
        put('Ц', 0b10010,0b10010,0b10010,0b10010,0b10010,0b11111,0b00001);
        put('Ч', 0b10001,0b10001,0b10001,0b01111,0b00001,0b00001,0b00001);
        put('Ш', 0b10101,0b10101,0b10101,0b10101,0b10101,0b10101,0b11111);
        put('Щ', 0b10101,0b10101,0b10101,0b10101,0b10101,0b11111,0b00001);
        put('Ъ', 0b11000,0b01000,0b01000,0b01110,0b01001,0b01001,0b01110);
        put('Ы', 0b10001,0b10001,0b10001,0b11001,0b10101,0b10101,0b11001);
        put('Ь', 0b10000,0b10000,0b10000,0b11110,0b10001,0b10001,0b11110);
        put('Э', 0b01110,0b10001,0b00001,0b00111,0b00001,0b10001,0b01110);
        put('Ю', 0b10010,0b10101,0b10101,0b11101,0b10101,0b10101,0b10010);
        put('Я', 0b01111,0b10001,0b10001,0b01111,0b00101,0b01001,0b10001);
        put('Ё', 0b01010,0b11111,0b10000,0b11110,0b10000,0b10000,0b11111);
